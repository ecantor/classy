...
class NoticesControllerTest < ActionController::TestCase
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post :create, notice: { destination: @notice.destination, message: @notice.message, note: @notice.note }
    end
  ...
  test "should update notice" do
    put :update, id: @notice, notice: { destination: @notice.destination, message: @notice.message, note: @notice.note }
    assert_redirected_to notice_path(assigns(:notice))
  end
